                ...
                <tr>
                    <td valign="top">
                        <!-- MENU CADASTRO - INICIO -->
                            <table width="99%" height="99%" class="Borda2a">
                            <tr>
                        ...
                        <!-- MENU CONSULTAS - FIM -->
                                    ...
                                    <table width="99%" class="Borda2">
                                        <tr>
                                            <td class="Borda4" height="20">Busca por Cracha</td>
                                        </tr>
                                        <tr>
                                            <td width="100%" height="20" valign="top" align="center">

                                           <?php echo form_open('cracha/buscar'); ?>

                                           <fieldset>
                                               <legend>Informe o crachá do prestador de serviços:</legend>
                                               <label>Crachá: </label>
                                               <input type="text" name="cracha" id="cracha" ></input>
                                               <input name="B1" src="http://10.152.16.34/sims/img/localizar1.gif" class="Botao" type="image">
                                           </fieldset>
