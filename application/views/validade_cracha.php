                    ...
                    <td valign="top">
                        ...
                        <!-- MENU CONSULTAS - FIM -->
                                    ...
                                    <table width="99%" class="Borda2">
                                        <tr>
                                            <td class="Borda4" height="20">Alterar data de validade</td>
                                        </tr>
                                        <tr>
                                            <td width="100%" height="20" valign="top" align="center">

                                           <?php echo form_open('cracha/atualizar'); ?>

                                           <fieldset>
                                               <legend>Atualizar data de validade:</legend>
                                               <label>Data: </label>
                                               <input  type="text" name="data" id="data" placeholder="Exemplo: 2016-01-20" ></input>
                                               <input type="hidden" name="cracha" value="<?php echo $cracha; ?>"></input>
